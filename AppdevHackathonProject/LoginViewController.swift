...
//    let or = UILabel()
    ...
    override func viewDidLoad() {
        ...
        let horzEmailLine = CGRect(x: 54, y: 361, width: 281.5, height: 0.5)
...
//        let username=usernameTextField.text ?? ""
    ...
    func setUpConstraints() {
        ...
        NSLayoutConstraint.activate([
            emailLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 312),
        ...
        NSLayoutConstraint.activate([
            emailTextField.bottomAnchor.constraint(equalTo: view.topAnchor, constant: 361),
